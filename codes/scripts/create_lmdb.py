...
img_filename="/data/55d/data_samples/RS/My_WHU-RS19_total"#图片文件目录
img_folder = img_filename+"/*"
# lmdb_save_path = "../SRDatasets/2020track2-test-input/x4_new.lmdb"
lmdb_save_path = img_filename+".lmdb"

meta_info = {"name": "x4"}
# print (os.getcwd())#获得当前目录
# print("111")
# print(os.path.exists("../data_samples/2020track2-test-input"))
# print("2222")
# print(os.listdir('../data_samples/2020track2-test-input'))
...
if osp.exists(lmdb_save_path):
    ...
    sys.exit(1)
img_list = sorted(glob.glob(img_folder))#按照原序取
